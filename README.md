...
**快速搜索**
- 多盘索引（运行时自动识别所有固定 NTFS 盘，不限 C/D），毫秒级大小写不敏感子串搜索
- 搜索范围：全部盘 / 指定盘符 / **预设文件夹**（设置中添加，只搜该文件夹子树）；范围下拉框按文本长度自适应宽度
- **分类标签筛选**：全部 / 文件夹 / 文档 / 图片 / 压缩包 / 其他
...
**设置与外观**
- 托盘「设置…」：主题、索引盘符、**预设文件夹**（系统文件夹选择器添加/删除）、开机自启（计划任务）、结果上限、最近条数、浮窗开关与显示项
